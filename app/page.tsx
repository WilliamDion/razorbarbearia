      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="relative z-10 text-center px-4 flex flex-col items-center">
          <div className="mb-6 animate-fade-in">
            <img 
              src="https://rrwxenfxczyiqdjhhxem.supabase.co/storage/v1/object/public/logos/razor.jpg" 
              alt="Logo" 
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tighter mb-6">
            Razor Barbearia<span className="text-primary inline-block hover:scale-110 transition-transform"></span>
          </h1>
